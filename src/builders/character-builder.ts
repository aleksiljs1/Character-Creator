...
export class CharacterBuilder {
    ...
    private static readonly HAIR_TYPES = ['None', 'Curly', 'Straight', 'Wavy', 'Bald'];
    private static readonly FACIAL_HAIR_TYPES = ['None', 'Beard', 'Mustache', 'Goatee'];
    private static readonly EYE_TYPES = ['Default', 'Blue', 'Green', 'Brown', 'Hazel'];
